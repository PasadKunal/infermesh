    ...
    <Layout>
      <div style={{ padding: "32px 36px" }}>
        <div style={{ marginBottom: 28 }}>
          <h1 style={{ color: "var(--text)", fontSize: 22, fontWeight: 600, margin: 0, letterSpacing: "-0.02em" }}>Request History</h1>
          <p style={{ color: "var(--text-3)", fontSize: 13, margin: "4px 0 0" }}>Last 50 requests across all your API keys</p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 24 }}>
          {[
            ...
            <div key={label} style={{ background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 12, padding: "16px 20px" }}>
              <p style={{ color: "var(--text-2)", fontSize: 11, fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.06em", margin: "0 0 8px" }}>{label}</p>
        ...
        {loading ? (
          ...
          <div style={{ background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 12, padding: "60px 40px", textAlign: "center" }}>
            <p style={{ color: "var(--text)", fontSize: 15, fontWeight: 500, margin: "0 0 8px" }}>No requests found</p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {filtered.map(log => (
              <div key={log.id} style={{ background: "var(--card-bg)", border: `1px solid ${log.cache_hit ? "#22c55e22" : "#1f1f1f"}`, borderRadius: 12, overflow: "hidden" }}>
                <div
                ...
                {expanded === log.id && (
                  <div style={{ borderTop: "1px solid #1a1a1a" }}>
                    <div style={{ padding: "16px 20px", borderBottom: "1px solid #1a1a1a" }}>
                      <p style={{ color: "var(--text-2)", fontSize: 11, fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.06em", margin: "0 0 8px" }}>Prompt</p>
                    ...
                    <div style={{ padding: "16px 20px", maxHeight: 300, overflowY: "auto" }}>
                      <p style={{ color: "var(--text-2)", fontSize: 11, fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.06em", margin: "0 0 8px" }}>Response</p>
                        ...
                        <ReactMarkdown
                          components={{
                            ...
                            code: ({node, inline, ...p}) => inline
                              ? <code style={{ background: "var(--bg-tertiary)", padding: "1px 5px", borderRadius: 4, fontSize: 12, fontFamily: "monospace", color: "#a78bfa" }} {...p} />
                              : <pre style={{ background: "#0d0d0d", border: "1px solid var(--border)", padding: "12px", borderRadius: 8, overflow: "auto", fontSize: 12, margin: "8px 0" }}><code style={{ color: "#a78bfa", fontFamily: "monospace" }} {...p} /></pre>,
